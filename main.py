        ...
        try:
            ...
            try:
                if response.json()['status_code'] == 0:
                    _lock.acquire()
                    print(Colorate.Horizontal(Colors.yellow_to_green, f'TikTok Viewbot by : Longth18_VCS | success: {success} '))
                    success += 1
                    _lock.release()
            except:
...
if __name__ == "__main__":
    ...
    set_title("Tiktok view Tool")
    txt = """\n\n
    TikTok Viewbot by @Weon \n"""
    print(
        Colorate.Vertical(
    ...
    try:
        link = str("https://www.tiktok.com/@longth18.cybersecurity/video/7180972034241940763?is_from_webapp=1&sender_device=pc&web_id=7181733379237709314")
        __aweme_id = str(
